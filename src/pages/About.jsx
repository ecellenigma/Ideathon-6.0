...
const About = () => {
    return (
        <div id='about' className="text-white relative flex flex-col items-center min-h-screen snap-start">
            <img src={AboutIdeathonHeader} alt="About Ideathon" className="mx-auto mt-20 mb-8" />

            <div className="max-w-5xl  mx-auto px-4  flex items-center">
                <p className="text-white font-['Montserrat'] md:text-[2.5vh] lg:text-[3vh] leading-relaxed text-center">
